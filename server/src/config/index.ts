...
export const config = {
  ...
  broadcast: {
    ...
    encoderPreset: optional('BROADCAST_ENCODER_PRESET', 'ultrafast'),
  ...
  overlay: {
    fontPath: optional('OVERLAY_FONT_PATH', path.join(appRoot, 'assets', 'fonts', 'Tajawal-Medium.ttf')),
    ...
    tickerBgColor: optional('TICKER_BG_COLOR', 'gradient-blue'),
